...
<button class="tablink" onclick="openPage('my_account', this, 'green')" >My Account</button>
<button class="tablink" onclick="openPage('reservations', this, 'green')" id="defaultOpen">My Reservations</button>
<button class="tablink" onclick="openPage('reviews', this, 'green')">Reviews</button>
<button class="tablink" onclick="openPage('parks', this, 'green')">Parking Slots</button>
<button class="tablink" onclick="openPage('vehicle', this, 'green')">Vehicle</button>
